    ...
    <section className="portfolio full-bg">
      ...
      <div className="glry-img">
        <div
          ...
          style={{ backgroundImage: `url(/assets/img/portfolio/full/Sanita4_1.jpg)` }}
          data-overlay-dark="2"
        ></div>
        <div
          id="tab-2"
          className="bg-img tab-img"
          style={{ backgroundImage: `url(/assets/img/portfolio/full/Sanita4_2.jpg)` }}
          data-overlay-dark="2"
        ></div>
        <div
          id="tab-3"
          className="bg-img tab-img"
          style={{ backgroundImage: `url(/assets/img/portfolio/full/Sanita4_3.jpg)` }}
          data-overlay-dark="2"
        ></div>
        <div
          id="tab-4"
          className="bg-img tab-img"
          style={{ backgroundImage: `url(/assets/img/portfolio/full/Sanita4_4.jpeg)` }}
          data-overlay-dark="2"
        ></div>
      </div>
    </section>
